...
<p1 style="color:CornflowerBlue;"><font size="5">The first thing I would do to create an Elevator for a building with 1000 floors would be to think of how 
...
be for the hundreds position and the 1000th floor..</font></p1><br>
<p2 style="color:CornflowerBlue;"><font size="5">For how people would choose which floor to go to, instead of the conventional buttons for each floor because 
...
the elevator is going, what floor it is currently on and which floors have been inputted and what the next floor is.</font></p2><br>
  <h3></h3>
<p3 style="color:CornflowerBlue;"><font size="5"> Since the elevator is for a building with 1000 floors it’s obvious that one elevator alone is not enough
...
in each elevator to allowing each person to connect and pass the time more efficiently especially for the higher most floors where cell
  signal would start to disappear</font></p3>
<a href="index.php"><font size="5">HOMEPAGE</font></a>
<a href="new-2.php"><font size="5">My Likes and dislikes</font></a>
<a href="LABWORK1_Fortuno.php"><font size="5">My Labwork 1</font></a>
