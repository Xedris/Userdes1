...
<p1 style="color:Lime;"><font size="5"> Dwayne is a student here in Asia Pacific College. He spends lots of his time working on his projects in 
...
Dwayne asks one of his professors, Sir Isaac, about the lab’s hours, to which he is told of the new web application that allows users to
  ...
  others in the room. They find their reserved place and begin gaming.</font>
</p1>
  <h5> <img src="Persona 1.jpg" alt="Dwayne" width="500" height="600"></h5>
<h1 style="color:Lime;"> Persona 2</h1>
  <p2 style="color:Lime;"> <font size="5">Sir Isaac is a Game Development Professor here at Asia Pacific College who also happens to be one of the founding members of 
...
One of his irregular students, Dwayne, sees the lecture-based reservation while browsing the website for a schedule, and recognizes that 
    ...
    choose another schedule.</font>
  </p2>
  <h6><img src="Persona 2.jpg" alt="Isaac" width="500" height="600"></h6>
<h1 style="color:Lime;"> Persona 3</h1>
 <p3 style="color:Lime;"><font size="5"> Miss Mara is an employee here at Asia Pacific College as part of the ITRO. Aside from managing the websites and other systems 
